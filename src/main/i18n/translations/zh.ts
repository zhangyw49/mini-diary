...
const translationsZh: Partial<Translations> = {
    ...
    // Preferences
    "allow-future-entries": "允许创建将来的日记",
    auto: "自动",
    "diary-entries": "日记",
    "enable-spellcheck": "拼写检查",
    "first-day-of-week": "一周的第一天",
    "hide-titles": "隐藏标题",
    no: "No",
    ok: "OK",
    "reset-diary": "重置日记本",
    "reset-diary-confirm": "是的，确定重置",
    ...
    "new-password": "新密码",
    password: "密码",
    "passwords-no-match": "输入不一致",
    "repeat-new-password": "请再次输入",
    ...
    // Statistics
    "total-entries": "日记篇数",
    "entries-per-week": "每周篇数",
    "streak-best": "历史最佳记录",
    "streak-current": "当前记录",
    "total-words": "总字数",
    "words-per-entry": "每篇字数",
